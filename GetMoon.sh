...
wget wget --output-document=$HOME/.conky/wekers/moon2.jpg https://static.die.net/moon/210.jpg
#wget wget --output-document=$HOME/.conky/wekers/moon2.jpg https://www.moongiant.com/images/today_phase/$img_in.jpg
sleep 1
